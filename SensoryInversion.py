...
def setup_pygame_window(screen_width):
    ...
    pygame.display.set_caption("Sensory Inversion")
...
#df.to_csv(filepath+'/tables/sensoryInversion/sensory_inversion.csv')
do_plots(all_ts_test[-1], all_robots_test[-1], all_light_sources_test[-1], filepath)
...
# genotype1 = [g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11, g12]
# cost, all_ts, all_robots, light_sources = run_sim(runs=1, animate=False, disturb_times=[20], adapt = True,
#                                                   left_motor_noise=0.5, right_motor_noise=0.5, noise_type='spike', genotype=genotype1)
#
# costs = []
# genes = []
# costs.append(cost)
...
#
# df = pd.DataFrame(temp, columns=cols)
# df.to_csv(filepath+'/tables/sensoryInversion/sensory_inversion_spike.csv')
# do_plots(all_ts_test[-1], all_robots_test[-1], all_light_sources_test[-1], filepath+'/graphs/sensoryInversion/spike')
#
#
# g1_values = create_discrete_genes()
# g2_values = create_discrete_genes()
...
# genotype1 = [g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11, g12]
# cost, all_ts, all_robots, light_sources = run_sim(runs=1, animate=False, disturb_times=[20], adapt = True,
#                                                   left_motor_noise=0.5, right_motor_noise=0.5, noise_type='white', genotype=genotype1)
#
# costs = []
# genes = []
# costs.append(cost)
...
#
# df = pd.DataFrame(temp, columns=cols)
# df.to_csv(filepath+'/tables/sensoryInversion/sensory_inversion_white.csv')
# do_plots(all_ts_test[-1], all_robots_test[-1], all_light_sources_test[-1], filepath+'/graphs/sensoryInversion/white')